...
pub fn deserialize<'a, T: Deserialize<'a>>(input: &'a [u8]) -> RaftDBResult<T> {
...
impl serde::ser::Serializer for &mut Serializer {
    ...
    type SerializeTupleStruct = Impossible<(), RaftDBError>;
    type SerializeMap = Impossible<(), RaftDBError>;
    type SerializeStruct = Impossible<(), RaftDBError>;
    type SerializeStructVariant = Impossible<(), RaftDBError>;

    /// bool simply uses 1 for true and 0 for false.
    fn serialize_bool(self, v: bool) -> RaftDBResult<()> {
        self.output.push(if v { 1 } else { 0 });
        Ok(())
    }

    fn serialize_i8(self, _: i8) -> RaftDBResult<()> {
        unimplemented!()
    }

    fn serialize_i16(self, _: i16) -> RaftDBResult<()> {
        unimplemented!()
    }

    fn serialize_i32(self, _: i32) -> RaftDBResult<()> {
        unimplemented!()
    }
    ...
    fn serialize_i64(self, v: i64) -> RaftDBResult<()> {
    ...
    fn serialize_u8(self, _: u8) -> RaftDBResult<()> {
        unimplemented!()
    }

    fn serialize_u16(self, _: u16) -> RaftDBResult<()> {
        unimplemented!()
    }

    fn serialize_u32(self, _: u32) -> RaftDBResult<()> {
        unimplemented!()
    }

    /// u64 simply uses the big-endian encoding.
    fn serialize_u64(self, v: u64) -> RaftDBResult<()> {
        self.output.extend(v.to_be_bytes());
        Ok(())
    }

    fn serialize_f32(self, _: f32) -> RaftDBResult<()> {
        unimplemented!()
    }
    ...
    /// ordered at the end.
    fn serialize_f64(self, v: f64) -> RaftDBResult<()> {
        let mut bytes = v.to_be_bytes();
    ...
    fn serialize_char(self, _: char) -> RaftDBResult<()> {
        unimplemented!()
    }

    /// Strings are encoded like bytes.
    fn serialize_str(self, v: &str) -> RaftDBResult<()> {
    ...
    fn serialize_bytes(self, v: &[u8]) -> RaftDBResult<()> {
        let bytes = v
            .iter()
    ...
    fn serialize_none(self) -> RaftDBResult<()> {
        unimplemented!()
    }

    fn serialize_some<T>(self, _: &T) -> RaftDBResult<()>
    where
        T: ?Sized + Serialize,
    {
        unimplemented!()
    ...
    fn serialize_unit(self) -> RaftDBResult<()> {
        unimplemented!()
    }
    ...
    fn serialize_seq(
        self,
        _: Option<usize>,
    ) -> RaftDBResult<Self::SerializeSeq> {
        Ok(self)
    }

    /// Tuples are serialized as the concatenation of the serialized elements.
    fn serialize_tuple(self, _: usize) -> RaftDBResult<Self::SerializeTuple> {
        Ok(self)
    }
    ...
    fn serialize_tuple_struct(
        ...
        _name: &'static str,
        _len: usize,
    ) -> RaftDBResult<Self::SerializeTupleStruct> {
        unimplemented!()
    }
    ...
    fn serialize_tuple_variant(
        ...
        variant: &'static str,
        _len: usize,
    ) -> RaftDBResult<Self::SerializeTupleVariant> {
        self.serialize_unit_variant(name, variant_index, variant)?;
        Ok(self)
    }
    ...
    fn serialize_map(
        self,
        _len: Option<usize>,
    ) -> RaftDBResult<Self::SerializeMap> {
        unimplemented!()
    }
    ...
    fn serialize_struct(
        ...
        _name: &'static str,
        _len: usize,
    ) -> RaftDBResult<Self::SerializeStruct> {
        unimplemented!()
    }
    ...
    fn serialize_struct_variant(
        ...
        _variant: &'static str,
        _len: usize,
    ) -> RaftDBResult<Self::SerializeStructVariant> {
        unimplemented!()
    }
}
...
impl serde::ser::SerializeSeq for &mut Serializer {
    ...
    fn serialize_element<T>(&mut self, value: &T) -> RaftDBResult<()>
    where
        T: ?Sized + Serialize,
    {
...
impl serde::ser::SerializeTupleVariant for &mut Serializer {
    ...
    fn serialize_field<T>(&mut self, value: &T) -> RaftDBResult<()>
    where
        T: ?Sized + Serialize,
    {
        value.serialize(&mut **self)
...
impl<'de> Deserializer<'de> {
    ...
    fn take_bytes(&mut self, len: usize) -> RaftDBResult<&[u8]> {
    ...
    fn decode_next_bytes(&mut self) -> RaftDBResult<Vec<u8>> {
...
impl<'de> serde::de::Deserializer<'de> for &mut Deserializer<'de> {
    ...
    fn deserialize_any<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
    ...
    fn deserialize_bool<V>(self, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
    ...
    fn deserialize_i8<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_i16<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_i32<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_i64<V>(self, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
    ...
    fn deserialize_u8<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_u16<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_u32<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_u64<V>(self, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
    ...
    fn deserialize_f32<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_f64<V>(self, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        let mut bytes = self.take_bytes(8)?.to_vec();
    ...
    fn deserialize_char<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_str<V>(self, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
    ...
    fn deserialize_string<V>(self, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        let bytes = self.decode_next_bytes()?;
    ...
    fn deserialize_bytes<V>(self, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        let bytes = self.decode_next_bytes()?;
    ...
    fn deserialize_byte_buf<V>(self, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        let bytes = self.decode_next_bytes()?;
    ...
    fn deserialize_option<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_unit<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_unit_struct<V>(self, _: &'static str, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_newtype_struct<V>(self, _: &'static str, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_seq<V>(self, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
    ...
    fn deserialize_tuple<V>(self, _: usize, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        visitor.visit_seq(self)
    ...
    fn deserialize_tuple_struct<V>(self, _: &'static str, _: usize, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_map<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_struct<V>(self, _: &'static str, _: &'static [&'static str], _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_enum<V>(self, _: &'static str, _: &'static [&'static str], visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
    ...
    fn deserialize_identifier<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
    ...
    fn deserialize_ignored_any<V>(self, _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
...
impl<'de> serde::de::SeqAccess<'de> for Deserializer<'de> {
    ...
    fn next_element_seed<T>(&mut self, seed: T) -> RaftDBResult<Option<T::Value>>
    where
...
impl<'de> serde::de::EnumAccess<'de> for &mut Deserializer<'de> {
    ...
    fn variant_seed<V>(self, seed: V) -> RaftDBResult<(V::Value, Self::Variant)>
    where
        V: DeserializeSeed<'de>
    {
        let index = self.take_bytes(1)?[0] as u32;
        let value: RaftDBResult<_> = seed.deserialize(index.into_deserializer());
        Ok((value?, self))
    }
}
...
impl<'de> serde::de::VariantAccess<'de> for &mut Deserializer<'de> {
    ...
    fn unit_variant(self) -> RaftDBResult<()> {
        Ok(())
    }

    fn newtype_variant_seed<T>(self, seed: T) -> RaftDBResult<T::Value>
    where
        T: DeserializeSeed<'de>
    {
    ...
    fn tuple_variant<V>(self, _: usize, visitor: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        visitor.visit_seq(self)
    ...
    fn struct_variant<V>(self, _: &'static [&'static str], _: V) -> RaftDBResult<V::Value>
    where
        V: Visitor<'de>
    {
        unimplemented!()
